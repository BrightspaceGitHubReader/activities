...
export default {
	...
	alreadyAdded: "Ya se agregó", // When seeing a list of activities that can be added to the learning path, these activities have already in the list.
	browseActivityLibrary: "Examinar biblioteca de actividades", // The title of the dialog box that allows you to browse potential activities to add to the learning path.
	...
	deleteSucceeded: "Se eliminó {activityName}.", //alert popup for delete activitie
	...
	untitledLearningPath: "Plan de aprendizaje sin título", // Default name of a learning path before the user has changed it.
};
