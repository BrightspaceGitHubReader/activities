...
export default {
	add: "追加", // When adding activities to the learning path, this will bulk add the selected potential activites to the learning path.
	addActivity: "アクティビティの追加", // Add a learning task to a list that are similar.
	alreadyAdded: "すでに追加済みです", // When seeing a list of activities that can be added to the learning path, these activities have already in the list.
	browseActivityLibrary: "質問ライブラリの参照", // The title of the dialog box that allows you to browse potential activities to add to the learning path.
	cancel: "キャンセル", // When adding activities to the learning path, this will cancel the currently selected potential activities and close the dialog box.
	clearSelected: "選択のクリア", // When adding activities (bulk add) to the learning path this allows you to clear the ones currently selected.
	course: "コース", // A set of material or a plan of study on a particular subject, usually leading learning a new skill.
	deleteSucceeded: "{activityName} は削除されました。", //alert popup for delete activitie
	...
	enterADescription: "説明を書く", // Shows where the user should write a description for the learning path.
