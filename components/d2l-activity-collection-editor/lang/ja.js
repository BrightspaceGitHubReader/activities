...
export default {
	...
	alreadyAdded: "すでに追加済み", // When seeing a list of activities that can be added to the learning path, these activities have already in the list.
	browseActivityLibrary: "アクティビティライブラリの参照", // The title of the dialog box that allows you to browse potential activities to add to the learning path.
