...
export default {
	...
	"editor.competenciesCount": "{count, plural, =0 {无学习目标} =1 {1 个已随附} other {{count} 个已随附}}", //Label for number of associated competencies
	"editor.competenciesCountSummary": "{count, plural, =0 {无学习目标} =1 {1 个学习目标} other {{count} 个学习目标}}",
