...
export default {
	...
	"ariaHidden": "已向学生隐藏", // Aria Label for the visibility switch when hidden
	...
	"setUngraded": "设置无成绩", // Menu item for setting the activity to ungraded
	...
	"createAndLinkToNewGradeItem": "创建和链接到新成绩项目", //Radio button text
